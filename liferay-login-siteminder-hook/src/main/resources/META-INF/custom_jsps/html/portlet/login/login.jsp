...
"SiteMinder Login JSP Hook"
		<aui:form action="http://openfeedportal.com:16458/siteminderagent/forms/login.fcc" method="post" name="fm">
			...
			<aui:fieldset>
				...
				<aui:input label="<%= loginLabel %>" name="USER" showRequiredLabel="<%= false %>" type="text" value="<%= login %>">
					<aui:validator name="required" />
				</aui:input>

				<aui:input label="password" name="PASSWORD" showRequiredLabel="<%= false %>" type="password" value="<%= password %>">
					<aui:validator name="required" />
				</aui:input>

				<span id="<portlet:namespace />passwordCapsLockSpan" style="display: none;"><liferay-ui:message key="caps-lock-is-on" /></span>

				<aui:input label="TARGET" name="TARGET" showRequiredLabel="<%= false %>" type="hidden" value="http://vaathmr1270.wellpoint.com:16458/lportal/user/ac08087/home">
